...
class PerAlgorithmSurvivalSVM:

    def __init__(self):
        self.logger = logging.getLogger("per_algorithm_survival_svm")
    ...
    def fit(self, scenario: ASlibScenario, fold: int, amount_of_training_instances: int):
        ...
        for algorithm_id in range(self.num_algorithms):
            ...
            model = FastSurvivalSVM(optimizer="rbtree", max_iter=1000, tol=1e-6, random_state=fold)
    ...
    def get_name(self):
        return "per_algorithm_survival_svm"